 ...
 */
namespace Magestore\Giftvoucher\Ui\DataProvider\GiftTemplate;
...
/**
 * Class DataProvider
 * @package Magestore\Giftvoucher\Ui\DataProvider\GiftTemplate
 */
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('giftcard_template');
        if (!empty($data)) {

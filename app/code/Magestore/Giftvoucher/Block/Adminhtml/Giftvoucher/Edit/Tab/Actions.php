    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'actions_fieldset', $formName = 'giftcard_code_form')
    {
        if (!$model) {
        ...
        $fieldset = $form->addFieldset(
            ...
            [
                'legend' => __(
                    'Allow using the gift code only if products in cart meet the following conditions ' .

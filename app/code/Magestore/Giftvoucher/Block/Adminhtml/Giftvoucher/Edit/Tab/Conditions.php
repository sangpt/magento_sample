...
/**
 * Class Conditions
 * @package Magestore\Giftvoucher\Block\Adminhtml\Giftvoucher\Edit\Tab
 */
    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'giftcard_code_form')
    {
        if (!$model) {

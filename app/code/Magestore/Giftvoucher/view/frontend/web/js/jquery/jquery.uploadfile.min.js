...
//    }
    ...
    b.fn.uploadFile = function (f) {
        var p = b.extend({id:"", url: "", method: "POST", enctype: "multipart/form-data", returnType: null, allowDuplicates: true, duplicateStrict: false, allowedTypes: "*", acceptFiles: "*", fileName: "file", formData: {}, dynamicFormData: function () {
                return{}
        ...
        function r(K, E, x) {
            for (var F = 0; F < x.length; F++) {
                ...
                H.filename.html(J);
                var y = b("<form style='display:block; position:absolute;left: 150px;' id='" + K.id + "' class='" + E.formGroup + "' method='" + K.method + "' action='" + K.url + "' enctype='" + K.enctype + "'></form>");
                y.appendTo("body");
                var A = [];
                A.push(x[F].name);
                w(y, G, H, A, E, x[F]);
        ...
        function k(D, C, z, x) {
            ...
            var B = b("<form id='" + z.id + "' method='" + z.method + "' action='" + z.url + "' enctype='" + z.enctype + "'></form>");
